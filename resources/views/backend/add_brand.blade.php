        ...
        <div class="col-sm-12 col-md-6 col-md-offset-3">
            ...
            <div class="panel bt-md b-primary">
                <div class="panel-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="{{ route('create_brand') }}" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="brandname" class="col-sm-2 control-label">Brand Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="brandname" id="brandname" value="{{ old('brandname') }}" placeholder="Artisan">
                                    </div>
                                </div>
                                    <div class="form-group">
