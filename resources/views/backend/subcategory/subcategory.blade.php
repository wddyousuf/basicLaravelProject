            ...
            <div class="panel bt-md b-primary">
                <div class="panel-content">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <a href="{{ route('add_subcategory') }}" class="btn btn-primary pull-right">Add Sub Category</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                                            ...
                                            @foreach ($subcategory as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('edit_sub_category',$row->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> </a>
